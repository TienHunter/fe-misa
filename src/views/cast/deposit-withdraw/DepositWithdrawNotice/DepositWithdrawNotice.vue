          ...
          <div class="flex items-center gap-0-24 pb-4">
            <div class="flex items-center">
              ...
              <span class="pl-1 font-bold">{{
                resultBulkAction?.totalPayemntExceute ?? 0
              }}</span>
            </div>
            <div class="flex items-center">
              <span>Số chứng từ thành công</span>
              <span class="pl-1 font-bold">{{
                resultBulkAction?.totalPaymentExcuteSuccess ?? 0
              }}</span>
            </div>
            <div class="flex items-center">
              <span>Số chứng từ không thành công</span>
              <span class="pl-1 font-bold">{{
                resultBulkAction?.totalPaymentExcuteFailure ?? 0
              }}</span>
            </div>
          </div>
        </div>
...
const resultBulkAction = computed(() => store.state.payment.resultBulkAction);
