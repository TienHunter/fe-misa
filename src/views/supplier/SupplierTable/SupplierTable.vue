    ...
    <div class="table-container">
      <table>
        <thead>
          <tr>
            <th
              v-for="(col, key, index) in SupplierCol"
              :key="index"
              :class="{
        ...
        <tbody>
          <template v-if="supplierList?.length > 0">
            <tr
              ...
              <td
                v-for="(col, key, indexCol) in SupplierCol"
                :key="indexCol"
                :class="{
                  ...
                  'before-last':
                    indexCol === Object.keys(SupplierCol).length - 2,
                }"
                :style="{
                  'z-index':
                    rowSelected === item.SupplierId && key === 'action' ? 1 : 0,
                }"
                ...
                <div
                  ...
                  <div
                    ...
                    :style="{
                      'z-index':
                        rowSelected === item.SupplierId && key === 'action'
                          ? 2
                          : 0,
                    }">
                    <div
          ...
          <template v-else>
            <tr>
              <td
                :colspan="Object.keys(SupplierCol).length"
                class="font-italic">
